...
export const CreateAgent: React.FC<CreateAgentProps> = ({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setError(isEditMode ? t('createAgent.updateFailed') : t('createAgent.createFailed'));
      setToast({ 
        message: isEditMode ? t('createAgent.updateFailed') : t('createAgent.createFailed'), 
        type: "error" 
      });
    } finally {
      setSaving(false);
  ...
  const handleBack = () => {
    if ((name !== (agent?.name || "") || 
        ...
        !confirm(t('createAgent.unsavedChangesConfirm'))) {
      return;
    }
    onBack();
  };
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <Button
                  ...
                  title={t('createAgent.backToAgents')}
                >
              ...
              <div>
                <h1 className="text-heading-1">
                  {isEditMode ? t('createAgent.editAgentTitle') : t('createAgent.createNewAgentTitle')}
                </h1>
                <p className="mt-1 text-body-small text-muted-foreground">
                  {isEditMode ? t('createAgent.editAgentSubtitle') : t('createAgent.createNewAgentSubtitle')}
                </p>
              </div>
            </div>
          ...
          <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        <div className="text-body-small font-medium">{t('createAgent.claude4Sonnet')}</div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        <div className="text-body-small font-medium">{t('createAgent.claude4Opus')}</div>
            ...
            <Card className="p-5">
              <div className="mb-4">
                ...
                <p className="text-caption text-muted-foreground">
                  {t('createAgent.systemPromptHint')}
                </p>
              </div>
