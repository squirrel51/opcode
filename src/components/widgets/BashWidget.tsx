  ...
  return (
    <div className="rounded-lg border bg-zinc-950 overflow-hidden">
      <div className="px-4 py-2 bg-zinc-900/50 flex items-center gap-2 border-b">
        ...
        <span className="text-xs font-mono text-muted-foreground">{t('bashWidget.terminal')}</span>
        {description && (
          <>
        ...
        {!result && (
          <div className="ml-auto flex items-center gap-1 text-xs text-muted-foreground">
            ...
            <span>{t('bashWidget.running')}</span>
          </div>
        )}
      </div>
      <div className="p-4 space-y-3">
        ...
        {result && (
          <div className={cn(
            ...
            {resultContent || (isError ? t('bashWidget.commandFailed') : t('bashWidget.commandCompleted'))}
          </div>
        )}
      </div>
    </div>
